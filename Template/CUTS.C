...
void CUTS(int ibatch, int ikind, int mchi, int mglu, float xsec){
  ...
  ostringstream btc; 
  btc << ibatch; 
  string  fout  = "./Plots/Plots_nj3_dron_f"+btc.str()+"_new.root";
  string  fcut  = "./CutPlots/cuts_nj3_dron_f"+btc.str()+"_new.root";
  string  ftree = "./JetTrees/jetTree_nj3_dron_f"+btc.str()+"_new.root";
  if(ikind == 4){
    ostringstream mch;
    ostringstream mgl;
    mch<<mchi;
    mgl<<mglu;
    fout = "./FewMassP/chi_"+mch.str()+"glu_"+mgl.str()+"_"+btc.str()+"dronf.root";
    fcut = "./FewMassP/cuts_chi_"+mch.str()+"glu_"+mgl.str()+"_"+btc.str()+"dronf.root";
    ftree = "./FewMassP/jetTree_nj3_"+mch.str()+"glu_"+mgl.str()+"_"+btc.str()+"dronf.root";
  }
